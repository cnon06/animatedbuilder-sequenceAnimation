    ...
    sequenceAnimation = SequenceAnimationBuilder()
        ...
        .addAnimatable(
            ...
            tag: 'height1')
             ...
             .addAnimatable(
            animatable: BorderRadiusTween(begin: BorderRadius.circular(0), end: BorderRadius.circular(100)), 
      ...
      body: Center(
        child: Column(
          ...
          children: [
                ...
                return Opacity(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: sequenceAnimation['radius1'].value, //BorderRadius.circular(0),
                    ),
            ...
            ElevatedButton(onPressed: () {animationController.forward(from: 0);}, child: Text('Start'))
          ],
        ),
      ),
    );
